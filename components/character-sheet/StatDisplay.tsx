...
export const StatDisplay: React.FC<{
    ...
    <div className={`flex flex-col items-center ${onClick ? 'cursor-pointer group' : ''}`} onClick={onClick}>
        <div className={`w-16 h-16 border-2 border-primary/50 rounded-full flex items-center justify-center bg-black/30 transition-colors duration-normal ${onClick ? 'group-hover:bg-primary/20 group-hover:border-primary' : ''}`}>
