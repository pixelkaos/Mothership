    ...
    // Marine
    {
        ...
        data: {
            character: {
                ...
                skills: {
                    trained: ['Military Training', 'Athletics', 'First Aid', 'Firearms'],
                    expert: ['Gunnery'],
                    master: [],
                },
                equipment: {
                    loadout: "Extermination: SMG, 6x Frag Grenades, Standard Battle Dress, 6x Stimpaks, Electronic Tool Kit",
    ...
    // Android
    {
        ...
        data: {
            character: {
                ...
                stress: { current: 2, minimum: 2 },
                skills: {
                    trained: ['Linguistics', 'Computers', 'Mathematics', 'Mechanical Repair', 'Scavenging'],
                    expert: ['Hacking'],
                    master: [],
                },
                equipment: {
                    loadout: "Excavation: Crowbar, Hand Welder, Laser Cutter, Body Cam, Bioscanner, Infrared Goggles, Lockpick Set, Vaccsuit",
    ...
    // Scientist
    {
        ...
        data: {
            character: {
                ...
                stress: { current: 2, minimum: 2 },
                skills: {
                    trained: ['Biology', 'Chemistry', 'Computers', 'First Aid', 'Geology'],
                    expert: ['Pathology', 'Botany'],
                    master: ['Exobiology'],
                },
                equipment: {
                    loadout: "Examination: Scalpel, Tranq Pistol, Stun Baton, Hazard Suit, Medscanner, 6x Automeds, 6x Pain Pills, 6x Stimpaks, Cybernetic Diagnostic Scanner",
                    trinket: "Alien Pressed Flower",
    ...
    // Teamster
    {
        ...
        data: {
            character: {
                ...
                stress: { current: 2, minimum: 2 },
                skills: {
                    trained: ['Industrial Equipment', 'Zero-G', 'Mechanical Repair'],
                    expert: ['Jury-Rigging', 'Engineering'],
                    master: [],
                },
                equipment: {
                    loadout: "Exploration: Vibechete, Rigging Gun, Flare Gun, First Aid Kit, Vaccsuit, Survey Kit, Water Filter, Locator, Rebreather, Binoculars, Camping Gear, 7x MREs",
                    trinket: "Faded Photograph",
                    patch: "#1 Worker",
                },
                credits: 280,
            },
