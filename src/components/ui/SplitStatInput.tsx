...
export const SplitStatInput: React.FC<{
    ...
    return (
        ...
        >
            ...
            <div className="relative flex items-center w-24 h-8 bg-transparent border border-muted rounded-full group-hover:border-primary transition-colors duration-200 ease-standard px-4 overflow-hidden">
                {/* Current Value Input */}
                <input
                    id={`${id}-current`}
                ...
                {/* Separator */}
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[125%] w-1 bg-muted transform rotate-[25deg] group-hover:bg-primary transition-colors duration-200 ease-standard"></div>
