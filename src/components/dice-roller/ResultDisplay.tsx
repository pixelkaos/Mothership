...
export const ResultDisplay: React.FC<ResultDisplayProps> = ({ result, onClear }) => (
    <div className="relative flex-1 flex flex-col items-center justify-center p-space-4 border border-primary/50 min-h-[240px]">
        {result && (
        ...
        {result ? (
            <>
                ...
                <div className="w-1/4 h-px bg-primary/50 my-space-4" />
                ...
                <span className="text-sm text-muted mt-space-2 font-mono">
                    {result.name}
