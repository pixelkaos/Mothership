...
export const CharacterRoller: React.FC<CharacterRollerProps> = ({ character, onUpdate, isVisible, isMinimized, initialPosition, onStateChange, activeCheck, onApplyRoll }) => {
    ...
    const tertiarySelectionClasses = (isSelected: boolean) => {
        ...
        return `${base} bg-transparent border border-tertiary text-tertiary hover:bg-tertiary/10 hover:text-foreground active:bg-tertiary/20`;
    }
        ...
        return (
            <div className="w-full mx-auto flex flex-col">
                ...
                <button 
                    ...
                    className="w-full mt-2 py-3 uppercase tracking-widest transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background focus:ring-focus bg-primary text-background hover:opacity-90 active:opacity-80 disabled:opacity-90 disabled:text-background/70 disabled:cursor-not-allowed"
                >
                    Roll
                </button>
        ...
        if (!rollInfo) {
            return (
                 <div className="w-full mx-auto flex flex-col items-center text-center">
                    <h3 className="text-xl font-bold tracking-wider uppercase text-danger">Error</h3>
        ...
        return (
            <div className="w-full mx-auto flex flex-col text-center">
                ...
                <div className="my-6">
                    <button 
                        onClick={handleRoll}
                        className="w-full py-4 uppercase tracking-widest transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background focus:ring-focus bg-transparent border border-secondary text-secondary hover:bg-secondary/20 active:bg-secondary/30"
                    >
                ...
                {creationResult && (
                    <div className="border-t border-primary/50 pt-4 space-y-4">
                        ...
                        <button
                            ...
                            className="w-full mt-2 py-3 uppercase tracking-widest transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background focus:ring-focus bg-primary text-background hover:opacity-90 active:opacity-80"
                        >
                            Apply to Character
                        </button>
                    </div>
            ...
            {renderResult()}
             <div className="space-y-3">
                ...
                <div className="grid grid-cols-[1fr_auto_1fr] gap-3 items-center">
                    ...
                    <button onClick={() => handleSimpleRoll('Dice', '1d100')} className="w-20 h-20 uppercase tracking-widest transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background focus:ring-focus bg-primary text-background hover:opacity-90 active:opacity-80">DICE</button>
